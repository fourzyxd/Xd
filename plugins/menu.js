...
const listMessage = {
  text: tek,
  footer: '📮 *Note:* Jika menemukan bug, error atau kesulitan dalam penggunaan silahkan laporkan/tanyakan kepada Owner 𝐊𝐮𝐫𝐨𝐍𝐞𝐰',
            ...
            templateButtons: [
                {
                    urlButton: {
                        displayText: `FOLLOW`,
                        url: 'https://instagram.com/My_Danz666'
                    }
                },
                {
                    urlButton: {
